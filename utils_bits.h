...
namespace mrpt
{
	...
	*/
	...
	namespace math
	{
		bool isNaN(float v);// MRPT_NO_THROWS;
		bool isNaN(double v);// MRPT_NO_THROWS;
		bool isFinite(float v);// MRPT_NO_THROWS;
		bool isFinite(double v);// MRPT_NO_THROWS;
